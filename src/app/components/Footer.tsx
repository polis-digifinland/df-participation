        ...
        <div className="mx-auto  max-w-screen-xl flex flex-wrap justify-evenly items-start text-sm relative bottom-0 py-5">
          <div className="flex flex-col w-full sm:w-1/3 min-w-[300px]">
            ...
            <ul className="flex flex-col w-full sm:w-1/3 list-none lg:px-12">
              ...
              <li className="m-2.5"><a target="_blank" rel="noreferrer" className="border-0" href="https://digifinland.fi/tietosuoja/">Tietosuoja</a></li>
              <li className="m-2.5"><a target="_blank" rel="noreferrer" className="border-0" href="https://digifinland.fi/toimintamme/polis-kansalaiskeskustelualusta/">Lisätietoja</a></li>
              ...
              <li className="m-2.5"><a target="_blank" rel="noreferrer" className="border-0" href="https://github.com/polis-digifinland/polis-digifinland">Lähdekoodi</a></li>
            </ul>
